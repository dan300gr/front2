...
const CatalogForm = ({ catalogo, onClose, refreshCatalogos }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (catalogo) {
        await axios.put(`https://api2-uetw.onrender.com/api/catalogos/${catalogo.catalogo_id}`, formData);
        Swal.fire({
          icon: 'success',
        ...
        await axios.post('https://api2-uetw.onrender.com/api/catalogos/', formData);
        Swal.fire({
          icon: 'success',
