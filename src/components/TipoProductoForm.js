...
const TipoProductoForm = ({ tipoProducto, onClose, refreshTiposProductos }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (tipoProducto) {
        await axios.put(`https://api2-uetw.onrender.com/api/tipos-producto/${tipoProducto.tipo_id}`, formData);
        Swal.fire({
          icon: 'success',
        ...
        await axios.post('https://api2-uetw.onrender.com/api/tipos-producto/', formData);
        Swal.fire({
          icon: 'success',
